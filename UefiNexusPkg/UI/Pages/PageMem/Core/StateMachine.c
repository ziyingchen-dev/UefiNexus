/** @file
  State machine implementation for PageMem core.

  This module manages PageMem page state initialization, state transitions, and
  redraw requests. It is pure logic and does not depend on UEFI, adapters, or
  platform services.
    ...
    )
{
    ...
    //
    // Mark the page for redraw only when the visible PageMem state changes.
    //
