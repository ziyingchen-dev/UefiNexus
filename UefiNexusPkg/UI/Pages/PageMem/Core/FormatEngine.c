/** @file
  Format engine implementation for PageMem core.

  This module formats memory bytes, multi-byte values, offsets, and addresses
  into ASCII strings for PageMem rendering. It is pure logic and does not
  depend on UEFI, adapters, or platform services.
