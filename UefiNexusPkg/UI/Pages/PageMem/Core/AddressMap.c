...
//
// Cached memory descriptor list provided by the controller through adapters.
//
// PageMem core does not own this buffer. The caller must ensure the descriptor
// buffer remains valid after PageCoreInitAddressMap() succeeds.
//
