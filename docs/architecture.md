...
This document describes the layered framework architecture using PageMem as a reference module.

## Repository Structure

The framework structure (using PageMem as a reference module) is organized as follows:
...
The Core layer owns generic page state management,
...
- `Core/Page/CursorEngine.c`
- `Core/Page/LayoutEngine.c`
- `Core/Page/AddressMap.c`
- `Core/Page/FormatEngine.c`
- `Core/Page/StateMachine.c`
- `Core/PageCore.h`
- `Core/PageCoreTypes.h`
